...
public class    EmployeeActivity extends AppCompatActivity {
    ...
    private String firstnameCurrent, lastnameCurrent;
    ...
    private void saveToDB() {
        ...
        Toast.makeText(this, "A new employee info has been saved !", Toast.LENGTH_LONG).show();
    }
    ...
    private void updateDB() {
        ...
        Toast.makeText(this, "Updated " + firstnameCurrent + " " + lastnameCurrent, Toast.LENGTH_LONG).show();
        firstnameCurrent = "";
        lastnameCurrent = "";
        readFromDB();
    }
    ...
    private void deleteDB() {
        Toast.makeText(this, "Deleting stuff" , Toast.LENGTH_LONG).show();
        readFromDB();
        try {
            Thread.sleep(1500);
